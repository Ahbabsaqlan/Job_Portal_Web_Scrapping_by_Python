...
CLASSIFICATIONS = "6008,6251,6263,6304,6123,6281,6076,6163,6205,1209,6092,1214,1225,1211,6246,1206,1210,1223,6058,1216,7019,1220,1200,6043,1203,1212,1204"
...
def fetch_job_details(job_id):
    ...
    referer_url = f"{HOST}/id/job/{job_id}"
    headers = {"User-Agent": user_agent, "Content-Type": "application/json", "Origin": HOST, "Referer": referer_url}
